...
const struct cmd_manual ice_root_manual = {
    ...
    .examples = H_EXAMPLE("ice reconfigure") H_EXAMPLE("ice build")
	H_EXAMPLE("ice -C /path/to/project flash") H_EXAMPLE("ice help config"),

    .extras = H_SECTION("SEE ALSO") H_ITEM(
	"ice help <command>", "Show the manual page for a specific command.")
