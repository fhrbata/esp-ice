...
static const struct cmd_manual manual = {
    ...
    .examples = H_EXAMPLE("ice build") H_EXAMPLE("ice -v build")
	H_EXAMPLE("ice -D IDF_TARGET=esp32s3 build"),

    .extras = H_SECTION("CONFIG") H_ITEM("core.build-dir",
					 "Build directory (default @b{build}).")
	H_ITEM("core.generator", "CMake generator passed on first configure "
				 "(default @b{Ninja}).")
	    H_ITEM("core.verbose",
		   "If true, show full command output instead of the "
		   "progress line.") H_ITEM("cmake.define",
					    "Repeatable @b{-D<key>=<value>} "
					    "entries forwarded to "
					    "cmake.")
